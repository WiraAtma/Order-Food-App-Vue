<template>
    <div class="fixed h-screen w-20 bg-red-400 flex flex-col items-center py-20 space-y-10 rounded-r-3xl shadow-lg">
      ...
      <router-link to="/admin" class="text-white text-sm font-semibold hover:bg-red-300 p-3 rounded-full">
