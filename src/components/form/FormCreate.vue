<script setup>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            import.meta.env.VITE_PUBLIC_API_KEY + '/menus',
            formData,
            {
                headers: {
          ...
          <form @submit="handleSubmit" class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2">
                ...
                <input @change="handleImage" type="file" name="image" id="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required="">
              </div>
            </div>
